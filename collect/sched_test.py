...
import time
from collect import scheduler_test
...
class Scheduler(object):
    ...
    def scheduler(self, type, job_id):
        ...
        if type == 'interval':
            self.sched.add_job(scheduler_test.test1, trigger=type, seconds=3, id=job_id, args=(type, job_id))
        elif type == 'cron':
